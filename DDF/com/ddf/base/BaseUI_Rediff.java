...
// zohoLoginTextBox_ClassName
		...
		try {
			if (locatorKey.endsWith("_Id")) {
				...
				//System.out.println("Xpath is:"+prop.getProperty(locatorKey));
	...
	*/
	...
	/*******************************************************/
	public void elementClear(String MyPortfolio_Xpath) {
		{
			
			getElement(MyPortfolio_Xpath).clear();
		}	
	}
	/****************** Click Element ***********************/
	// zohoLoginTextBox_ClassName
	public void elementClick(String signinBtn_Xpath) {
		try {
			//System.out.println("xpathKey is:"+xpathKey);
			getElement(signinBtn_Xpath).click();
			reportPass(signinBtn_Xpath + " : Element Clicked Successfully");
		} catch (Exception e) {
			reportFail(e.getMessage());
		}
	}
